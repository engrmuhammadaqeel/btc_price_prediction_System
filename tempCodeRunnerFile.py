...
def load_model_and_scaler():
    ...
    try:
        base = os.path.join("fine tuned model", "Random Forest Regressor")

        rf_model = joblib.load(os.path.join(base, "rf_btc_prediction_model.pkl"))

        with open(os.path.join(base, "rf_scaler.pkl"), "rb") as f:
            scaler = pickle.load(f)

        with open(os.path.join(base, "rf_config.pkl"), "rb") as f:
